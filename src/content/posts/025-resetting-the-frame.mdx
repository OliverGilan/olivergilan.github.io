...
<ImageCarousel images={[
  { src: "/images/figma_make.png", alt: "Figma make chatbox" },
  { src: "/images/canva_make.png", alt: "Canva app builder" },
  { src: "/images/airtable_make.png", alt: "Airtable app builder" },
  { src: "/images/codegen.png", alt: "Codegen" },
]} />
</div>
