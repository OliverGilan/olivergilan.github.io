...
When installing dependencies, use `bun`

When adding or changing dependencies, use the command line e.g. `bun add [package]`

Leave package version out of the command unless explicitly told otherwise.
